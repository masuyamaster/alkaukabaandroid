...
class GerhanaActivity : AppCompatActivity() {
    ...
    // Override lokasi murni lokal untuk layar Gerhana (prefs terpisah dari SessionManager,
    // tidak pernah menulis/membaca pengaturan lokasi global) - lihat PageLocationOverride.
    ...
    companion object {
        ...
        // Nama prefs lama - jangan diubah (override yang sudah tersimpan di device pengguna).
